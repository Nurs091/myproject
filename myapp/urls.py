...
from .views import ForgotPasswordView, VerifyResetCodeView
from .views import (
...
urlpatterns = [
    # HTML-страница регистрации (она содержит JS, отправляющий данные на /api/register/)
    path('register/', views.register_page, name='register'),

    # Стандартные Django маршруты
